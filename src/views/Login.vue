          ...
          <div class="col-lg-6">
            <div class="timeline-logo-area d-flex align-items-center">
              ...
              <div class="timeline-tagline">
                <h6 class="tagline">
                  It’s helps you to connect and share with the people in your
                  life
                </h6>
              </div>
            </div>
          ...
          <div class="col-lg-6 order-2 order-lg-1">
            <div class="timeline-bg-content bg-img">
              <h3 class="timeline-bg-title">
                Let’s see what’s happening to you and your world. Welcome in
                Adda.
              </h3>
            </div>
          </div>
...
<style scoped>
.timeline-bg-content {
  background-image: url(../assets/images/timeline/adda-timeline.jpg);
}
</style>
