                    ...
                    <li class="msg-trigger">
                      ...
                      <div class="message-dropdown" id="a">
                        ...
                        <ul class="dropdown-msg-list">
                          <li
                            class="msg-list-item d-flex justify-content-between"
                          >
                            <!-- profile picture end -->
              ...
              >
                ...
                <div class="profile-setting-box">
                  <div class="profile-thumb-small">
                    ...
                    <div class="profile-dropdown" v-if="profileVisible">
                      ...
                      <div class="profile-body">
                        <ul>
                          ...
                          <li>
                            <a href="#"
                              ><i class="flaticon-message"></i>Inbox</a
                            >
                          </li>
                          <li>
                            <a href="#"
                              ><i class="flaticon-document"></i>Activity</a
                            >
                          </li>
                        </ul>
                        <ul>
